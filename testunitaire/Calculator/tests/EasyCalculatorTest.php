...
use EasyCalculator\EasyCalculator;

class EasyCalculatorTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->calculator = new EasyCalculator;
    }
...
//        );
    ...
    {
        $this->setExpectedException('InvalidArgumentException', 'this (five) is not a number ');
        $this->calculator->add('five');
    }
}